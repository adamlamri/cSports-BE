...
public class JwtService {
    ...
    public static final String MGM_IAT = "spectre-iat";
    ...
    public JWTClaimsSet parseToken(String token, String audience) {
        ...
        try {
            ...
            SportsTrackerUtils.ensureAuthority(audience != null &&
                            claims.getAudience().contains(audience),
                    "Wrong audience");

            SportsTrackerUtils.ensureAuthority(claims.getExpirationTime().after(new Date()),
                    "Spring expiredToken");
    ...
    public JWTClaimsSet parseToken(String token, String audience, long issuedAfter) {
        ...
        SportsTrackerUtils.ensureAuthority(issueTime >= issuedAfter,
                "Obsolete Token");
