package sportstracker.common.exception;
...
@ControllerAdvice
@Slf4j
public class ExceptionCenterHandler extends ResponseEntityExceptionHandler {
    ...
    /**
     * Handle wrong type, example double couldn't converted to String.
     *
    ...
    /**
     * Handle exception when storage file
     *
    ...
    /**
     * Handle exception when file isn't exists
     *
     * @param ex FileNotFoundException
     * @return the ApiError object
     */
    @ExceptionHandler(FileNotFoundException.class)
    protected ResponseEntity<Object> handleMyFileNotFoundException(FileNotFoundException ex) {
        ApiError apiError = new ApiError(NOT_FOUND);
        apiError.setMessage(ex.getMessage());
        return buildResponseEntity(apiError);
    }
    ...
    /**
     * Handle exception when invalid file extension
     *
