...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    private SpectreOidcUserService oidcUserService;
    ...
    public SecurityConfig(AccountService accountService,
                          ...
                          SpectreOidcUserService oidcUserService,
                          SpectreOAuth2UserService oAuth2UserService) {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http.
                ...
                .addFilterBefore(
                        new SpectreTokenAuthenticationFilter(super.authenticationManager(), properties),
